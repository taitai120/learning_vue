<template>
  <li class="mb-7">
    <router-link
      to="/jobs/results/1"
      class="block mx-auto bg-white border border-solid border-brand-gray-1 rounded hover:shawdow-gray"
    >
          ...
          <div>
            <ul class="pl-8 list-disc">
              ...
              <li>
                ...
                Perferendis hic enim inventore error quo, impedit doloribus! Aut
                natus repellat optio.
              </li>
            </ul>
          </div>
